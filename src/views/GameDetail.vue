      ...
      <div class="content-box-main slide-up">
        ...
        <div class="right-section card">
          <div class="activity-header-row">
            ...
            <!-- CORRECCIÓN 1: Usamos toggleGameLike -->
            <button 
              class="fav-btn" 
        ...
        <div class="reviews-list">
          <div v-for="review in reviews" :key="review.id_review" class="review-card card fade-in">
            ...
            <div class="review-actions">
                <!-- CORRECCIÓN 2: Usamos toggleReviewLike -->
                <button 
                  class="like-btn" 
...
const fetchUserActivity = async (gameId) => {
  // ACTIVAMOS LA BANDERA DE PROTECCIÓN
...
const submitReview = async (data) => {
  ...
  try {
    const payload = {
        id_game: game.value.id_game, content: data.content, rating: data.rating, has_spoilers: data.has_spoilers,
    };
